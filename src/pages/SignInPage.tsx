...
export default function SignInPage() {
  ...
  return (
    <section className="signup-page signin-page">
      <div className="signup-page__shell">
        <div className="signup-page__intro">
          <h1 className="signup-page__title">Welcome back 👋</h1>
        </div>
          ...
          {emailSuccess ? (
            ...
            <form onSubmit={handleSubmit} className="signup-page__form">
              ...
              <div className="signup-page__field">
                <label htmlFor="si-email" className="signup-page__label">
                  Email address
                </label>
                <input
                  id="si-email"
              ...
              <div className="signup-page__field">
                <label htmlFor="si-password" className="signup-page__label">
                  Password
                </label>
        ...
        <div className="signup-page__footer">
          <span className="signup-page__footer-text">Don’t have an account?</span>
          <Link to="/sign-up" className="signup-page__footer-link">Sign up</Link>
        </div>
